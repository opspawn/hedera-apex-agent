...
export function AgentCard({ agent, onSelect }: AgentCardProps) {
  ...
  return (
    <div
      ...
      className="bg-hedera-card border border-hedera-border rounded-xl p-5 hover:border-hedera-green/40 transition-all cursor-pointer group animate-slide-up"
    >
      ...
      <div className="flex items-center justify-between pt-3 border-t border-hedera-border">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1">
            <svg className={`w-3.5 h-3.5 ${trustColor}`} fill="currentColor" viewBox="0 0 20 20">
