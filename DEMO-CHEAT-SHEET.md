...
| Agent | ID | Key Skill |
|-------|----|-----------|
| SentinelAI | `0.0.17717642363661` | `smart-contract-audit` (5 HBAR) |
| LinguaFlow | `0.0.17717642363682` | `translation` |
| DataWeaver | `0.0.17717642363683` | `data-pipeline` |
| AutoPilot | `0.0.17717642363684` | `workflow-orchestration` |
| VisionForge | `0.0.17717642363685` | `object-detection` |
| ChainOracle | `0.0.17717642363686` | `price-feed` |
| DocuMind | `0.0.17717642363687` | `document-extraction` |
| TaskSwarm | `0.0.17717642363698` | `task-decomposition` |
